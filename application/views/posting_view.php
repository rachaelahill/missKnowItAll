<!--  ==================== POSTING CONTENT ====================	-->		
  <div class="form-wrapper">
    ...
    <?=form_open('client/create_post', array('class' => 'post-form'));?>
  		<label>Title:</label>
  		<p><input type="text" name="titleInpt" data-validate="validate(required)" class="post-inpt" placeholder="Ex: First Post"/></p>
  		...
  		<p><input type="text" name="signInpt" data-validate="validate(required)" class="post-inpt" placeholder="Ex: John Smith" /></p>
  		<input type="hidden" name="noResp" value="no"/>
